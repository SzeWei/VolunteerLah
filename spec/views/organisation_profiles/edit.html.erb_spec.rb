...
RSpec.describe "organisation_profiles/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit organisation_profile form" do
    render

    assert_select "form[action=?][method=?]", organisation_profile_path(@organisation_profile), "post" do
